...
export const jpToEnTypeMap: Record<string, string> = Object.fromEntries(
    typeMap.map(t => [t.japanese, t.english])
);
export const enToJpTypeMap: Record<string, string> = Object.fromEntries(
    typeMap.map(t => [t.english, t.japanese])
);
